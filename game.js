...
const sounds = {
    ...
    caneConcretecenter: new Howl({src: ['sounds/cane/cane_on_concrete_center.wav'], stereo: -1}),
...
caneCementcenter: new Howl({src: ['sounds/cane/cane_on_cement_center.wav'], stereo: -1}),
...
skateboardCenter: new Howl({src: ['sounds/skateboard/skateboard_center.wav'], stereo: -1}),
